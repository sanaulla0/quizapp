...
const SortingQuiz = () => {
  const [questions, setQuestions] = useState([
    ...
    { id: 1, text: 'Sort ASSENDING ORDER', 
    options: [
      { id: 2, name: '2'},
      { id: 1, name: '1'},
      { id: 3, name: '3'  },
    ...
    { id: 1, text: 'SORT DESCENDING ORDER', 
    options: [
      { id: 2, name: '80'  },
      { id: 1, name: '90' },
      { id: 3, name: '70' },
    ...
    { id: 1, text: 'SORT VEHICLES ', 
    options: [
      { id: 2, name: 'AUTO'  },
      { id: 1, name: 'MOTAR CYCLE' },
      { id: 3, name: 'CAR' },
      { id: 4, name: 'BUS' },
    ],
    flag : false,
    ...
    { id: 1, text: 'Sort these countries by population:', 
    options: [
      { id: 2, name: 'China', population: 2 },
      { id: 1, name: 'India', population: 1 },
      { id: 3, name: 'United States', population: 4 },
      { id: 4, name: 'Indonesia', population: 3 },
    ],
    flag : false,
    isCompleted : false
  },
